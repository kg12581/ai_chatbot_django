...
> 生成时间：2026-08-02 21:26:24　|　测试框架：pytest + pytest-django + pytest-cov + Playwright

## 一、测试结果总览

- ✅ **73 / 73 个测试全部通过**（后端 65 + 前端 8）
- ⏱️ 总耗时：26.9 秒
- 📊 代码覆盖率：**57%**
...
项目当前 **73 个测试全部通过**，后端逻辑（爬虫、扫描、调度、权限）与前端核心页面
